    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-slate-100 dark:border-slate-800 pb-6 mb-6">
        ...
        <div class="flex flex-col items-end gap-3 shrink-0 w-full md:w-auto">
            ...
            <div class="flex shrink-0 gap-3 w-full md:w-auto">
                ...
                <a href="{{ route('pastes.create') }}" class="flex-1 md:flex-none justify-center flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2.5 rounded-xl transition-all font-semibold shadow-sm shadow-indigo-500/30 dark:shadow-indigo-900/40">
